...
public interface NATSInterface extends BaseInterface {

	abstract boolean isStandaloneMode();
	
	/**
	 * Get NATS Client version info.
	 * @return
	 */
	...
	/**
	 * Returns a reference to the EntityInterface.
	 */
	public EntityInterface getEntityInterface();
	
	/**
	 * Returns a reference to the EnvironmentInterface.
	 */
	public EnvironmentInterface getEnvironmentInterface();
	
	/**
	 * Returns a reference to the EquipmentInterface.
	 */
	public EquipmentInterface getEquipmentInterface();
	
	/**
	 * Returns a reference to the RiskMeasuresInterface.
	 */
	...
	/**
	 * Returns a reference to the SimulationInterface.
	 */
