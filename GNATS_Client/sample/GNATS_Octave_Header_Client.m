...
javaaddpath([str_GNATS_HOME, 'dist/gnats-client.jar']);
javaaddpath([str_GNATS_HOME, 'dist/gnats-shared.jar']);
javaaddpath([str_GNATS_HOME, 'dist/json.jar']);
javaaddpath([str_GNATS_HOME, 'dist/commons-logging-1.2.jar']);
javaaddpath([str_GNATS_HOME, 'dist/rmiio-2.1.2.jar']);

addpath("sample/");
DIR_share = "share/";

%Please enter GNATS Server location
%GNATS_Server = '../GNATS_Server/';
...
GNATSClientFactory = javaObject('GNATSClientFactory');
