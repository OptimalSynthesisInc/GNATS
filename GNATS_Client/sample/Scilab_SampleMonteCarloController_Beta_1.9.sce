...
if (~isdir(GNATS_HOME)) then
    ...
    javaclasspath(GNATS_HOME + '/dist/gnats-client.jar');
    javaclasspath(GNATS_HOME + '/dist/gnats-shared.jar');
    javaclasspath(GNATS_HOME + '/dist/json.jar');
    javaclasspath(GNATS_HOME + '/dist/commons-logging-1.2.jar');
