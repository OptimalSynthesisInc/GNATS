...
/**
 * Actual RMI class which implements RemoteWeather
 */
public class ServerWeather extends ServerClass implements RemoteWeather {
	
	public ServerWeather(ServerNATS serverNATS) throws RemoteException {
		super(serverNATS);
	}

	public int downloadWeatherFiles() throws RemoteException {
		return cEngine.downloadWeatherFiles();
	}
	...
	public float[] getWind(float timestamp_sec,
		...
		return cEngine.getWind(timestamp_sec, latitude_deg, longitude_deg, altitude_ft);
	}
	...
	public WeatherPolygon[] getWeatherPolygons(String ac_id, double lat_deg, double lon_deg, double alt_ft, double nauticalMile_radius) throws RemoteException {
		return cEngine.getWeatherPolygons(ac_id, lat_deg, lon_deg, alt_ft, nauticalMile_radius);
	}
}
