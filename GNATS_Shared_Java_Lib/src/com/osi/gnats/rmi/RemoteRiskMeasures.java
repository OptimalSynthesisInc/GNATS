...
public interface RemoteRiskMeasures extends BaseRemote {
	public Object getFlightsInRange(int sessionId, String aircraftID, float minLatitude, float maxLatitude, float minLongitude, float maxLongitude, float minAltitude_ft, float maxAltitude_ft) throws RemoteException;
