...
#ifndef CUDA_AIRCRAFT_NEW_H_
#define CUDA_AIRCRAFT_NEW_H_
...
//	vector<real_t>           course_rad_taxi;
	...
	__host__ CUDA_Aircraft_new();
//	__host__ CUDA_Aircraft_new(const CUDA_Aircraft& that);
	__host__ ~CUDA_Aircraft_new();
