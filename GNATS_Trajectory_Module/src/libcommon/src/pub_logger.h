...
static const char* ENUM_Log_Level_String[] = {
    FOREACH_LOG_LEVEL(GENERATE_STRING)
};

const int ENUM_Log_Level_Count = 3;
 ...
 *
 * Parameter
 * arg_count: Number of log parameters to send.  This refers to the number of variable parameters(final argument [...]).
