...
#ifndef __NATSSTAR_H__
#define __NATSSTAR_H__
...
class NatsStar {
 public:
  ...
  bool operator<(const NatsStar& that) const;

  bool operator==(const NatsStar& that) const;
};

#endif  /* __NATSSTAR_H__ */
