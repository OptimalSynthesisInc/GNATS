...
#ifndef __FLIGHTPLANPARSER_H__
#define __FLIGHTPLANPARSER_H__
...
string PROC_TYPE_SID = "SID";
string PROC_TYPE_ENROUTE = "ENROUTE";
string PROC_TYPE_STAR = "STAR";
string PROC_TYPE_APPROACH = "APPROACH";
