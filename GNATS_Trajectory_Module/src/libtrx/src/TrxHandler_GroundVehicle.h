...
#ifndef TRXHANDLER_GROUNDVEHICLE_H_
#define TRXHANDLER_GROUNDVEHICLE_H_
...
class TrxHandler_GroundVehicle {
public:
	TrxHandler_GroundVehicle() :
		startTime(-1),
		currentTrackTime(0) {
	}

	virtual ~TrxHandler_GroundVehicle() {
	}
