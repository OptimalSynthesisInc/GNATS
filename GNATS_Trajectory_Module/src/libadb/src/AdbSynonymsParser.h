...
#ifndef ADBSYNONYMSPARSER_H_
#define ADBSYNONYMSPARSER_H_
...
class AdbSynonymsParser : public AdbFileParser, public AdbParserListener {
public:
	AdbSynonymsParser(map<string, string>& synonyms, const string& fname);
	virtual ~AdbSynonymsParser();
