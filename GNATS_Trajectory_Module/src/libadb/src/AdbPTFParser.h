...
#ifndef ADBPTFPARSER_H_
#define ADBPTFPARSER_H_
...
class AdbPTFParser : public AdbFileParser, public AdbParserListener {
public:
    AdbPTFParser(AdbPTFModel& ac, const string& fname);
    virtual ~AdbPTFParser();
