...
#ifndef AIRPORTLAYOUTDATALOADER_H_
#define AIRPORTLAYOUTDATALOADER_H_
...
// Map structure containing available airport ground waypoint connectivity
extern map<string, GroundWaypointConnectivity> map_ground_waypoint_connectivity;
...
class AirportLayoutDataLoader {

public:
	AirportLayoutDataLoader();
	~AirportLayoutDataLoader();

	int loadAirportLayout(const string& dirname);
};
