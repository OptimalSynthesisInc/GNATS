...
public:
   ...
   * 
   * @newin{2,26}
   * Deprecated: 2.62: TimeVal is not year-2038-safe. Use
   ...
   *  @a text. ISO 8601 strings of the form <date><sep><time><tz> are supported.
   * 
   ...
   * or <tt>nullptr</tt> in the case that there was an error (such as a format specifier
   * not being supported in the current locale).
   */
