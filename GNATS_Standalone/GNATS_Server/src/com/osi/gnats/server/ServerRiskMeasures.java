...
public class ServerRiskMeasures extends ServerClass implements RemoteRiskMeasures {
	 ...
	 */
	public Object getFlightsInRange(int sessionId, String refAircraftId, float minLatitude, float maxLatitude, float minLongitude, float maxLongitude, float minAltitude_ft, float maxAltitude_ft) {
		...
		ay = minLongitude;
		bx = minLatitude + 0.5f;
		by = minLongitude - 0.5f;
		cx = maxLatitude;
		cy = maxLongitude;
		dx = maxLatitude - 0.5f;
		dy = maxLongitude + 0.5f;
		...
		maxAlt = maxAltitude_ft;
		minAlt = minAltitude_ft;
	...
	public int load_flightphase_aviationOccurence_mapping(String dirPath) throws RemoteException {
		return cEngine.load_flightphase_aviationOccurence_mapping(dirPath);
	}
	
	public int setSampleWeatherHazard(double[] weatherRegionBounds) throws RemoteException {	
		return cEngine.setSampleWeatherHazard(weatherRegionBounds);
	}
	
	public String[] calculateRisk(String flightData) throws RemoteException {		
		return cEngine.calculateRisk(flightData, ServerNATS.cifpExists);
	}
	
	public int setRegionOfRegard(String aircraft, double[] regionBounds) throws RemoteException {
		return cEngine.setRegionOfRegard(aircraft, regionBounds);
	}
	
	public double[][] getRegionOfRegard(String aircraft) throws RemoteException {
		return cEngine.getRegionOfRegard(aircraft);
	}
	
	public String[] getAircraftInRegionOfRegard(String aircraft) throws RemoteException {
		return cEngine.getAircraftInRegionOfRegard(aircraft);
	}
	
	public double getL2Distance(String airportId, String vehicle1, String vehicle2) throws RemoteException {
		return cEngine.getL2Distance(airportId, vehicle1, vehicle2);
	}
	
	public double getTimeToObjectOfInterest(String airportId, String vehicle1, float latitude, float longitude) {
		return cEngine.getTimeToObjectOfInterest(airportId, vehicle1, latitude, longitude);
	}
	
	public double getDistanceToObjectOfInterest(String airportId, String vehicle1, float latitude, float longitude) {
		return cEngine.getDistanceToObjectOfInterest(airportId, vehicle1, latitude, longitude);
	}
	
	public double getTimeToVehicleContact(String vehicle1, String vehicle2) {
		return cEngine.getTimeToVehicleContact(vehicle1, vehicle2);
	}
	
	public double getTimeToPavementEdge(String vehicleId) {
		return cEngine.getTimeToPavementEdge(vehicleId);
	}
	
	public double getRateOfLineOfSightChange(String aircraftID1, String aircraftID2) {
		return cEngine.getRateOfLineOfSightChange(aircraftID1, aircraftID2);
	}
	
	public double getRateOfApproachToPavementEdge(String aircraftID, int timesteps) {
		return cEngine.getRateOfApproachToPavementEdge(aircraftID, timesteps);
	}
	
	public double getRateOfApproachToVehicle(String vehicle1ID, String vehicle2ID, int timesteps) {
		return cEngine.getRateOfApproachToVehicle(vehicle1ID, vehicle2ID, timesteps);
	}
	
	public double getRateOfApproachToWaypoint(String aircraftID, String waypoint, int timesteps) {
		return cEngine.getRateOfApproachToWaypoint(aircraftID, waypoint, timesteps);
	}
	
	public double getRateOfApproachToWaypoint(String aircraftID, float waypointLatitude, float waypointLongitude, int timesteps) {
		return cEngine.getRateOfApproachToWaypoint(aircraftID, waypointLatitude, waypointLongitude, timesteps);
	}
	
	public double getRateOfApproachToEvent(String aircraftID, float eventCenterLatitude, float eventCenterLongitude, int timesteps) {
		return cEngine.getRateOfApproachToEvent(aircraftID, eventCenterLatitude, eventCenterLongitude, timesteps);
	}
	
	public double getRateOfApproachToWeatherEvent(String aircraftID, double[] weatherBounds) {
		return cEngine.getRateOfApproachToWeatherEvent(aircraftID, weatherBounds);
	}
	
	public double getRateOfApproachToWakeVortex(String leadingAircraftID, String trailingAircraftID) {
		return cEngine.getRateOfApproachToWakeVortex(leadingAircraftID, trailingAircraftID);
	}
	
	public double getRateOfVelocityAlignmentToRunway(String aircraftID, String procedure, int timesteps) {
		return cEngine.getRateOfVelocityAlignmentToRunway(aircraftID, procedure, timesteps);
	}
	
	public double getRateOfApproachToRunwayEnd(String aircraftID, int timesteps) {
		return cEngine.getRateOfApproachToRunwayEnd(aircraftID, timesteps);
	}
	
	public double getRateOfApproachToRunwayThreshold(String aircraftID, int timesteps) {
		return cEngine.getRateOfApproachToRunwayThreshold(aircraftID, timesteps);
	}
