...
public class CEngine {
	...
	public native int load_flightphase_aviationOccurence_mapping(String dirPath);
	
	public native int setSampleWeatherHazard(double[] weatherRegionBounds);
		
	public native String[] calculateRisk(String flightData, boolean cifpExists);
	
	public native int setRegionOfRegard(String aircraft, double[] regionBounds);
	
	public native double[][] getRegionOfRegard(String aircraft);
	
	public native String[] getAircraftInRegionOfRegard(String aircraft);
	
	public native double getL2Distance(String airportId, String vehicle1, String vehicle2);
	
	public native double getTimeToObjectOfInterest(String airportId, String vehicle1, float latitude, float longitude);
	
	public native double getDistanceToObjectOfInterest(String airportId, String vehicle1, float latitude, float longitude);
	
	public native double getTimeToVehicleContact(String vehicle1, String vehicle2);
	
	public native double getTimeToPavementEdge(String vehicleId);
	
	public native double getRateOfLineOfSightChange(String aircraftID1, String aircraftID2);
		
	public native double getRateOfApproachToPavementEdge(String aircraftID, int timesteps);
	
	public native double getRateOfApproachToVehicle(String vehicle1ID, String vehicle2ID, int timesteps);
		
	public native double getRateOfApproachToWaypoint(String aircraftID, String Waypoint, int timesteps);
	
	public native double getRateOfApproachToWaypoint(String aircraftID, float waypointLatitude, float waypointLongitude, int timesteps);
	
	public native double getRateOfApproachToEvent(String aircraftID, float eventCenterLatitude, float eventCenterLongitude, int timesteps);
	
	public native double getRateOfApproachToWeatherEvent(String aircraftID, double[] weatherBounds);
	
	public native double getRateOfApproachToWakeVortex(String leadingAircraftID, String trailingAircraftID);
	
	public native double getRateOfVelocityAlignmentToRunway(String aircraftID, String procedure, int timesteps);
	
	public native double getRateOfApproachToRunwayEnd(String aircraftID, int timesteps);
	
	public native double getRateOfApproachToRunwayThreshold(String aircraftID, int timesteps);
