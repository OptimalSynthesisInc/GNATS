...
safetyMInterface    =    gnatsStandalone.getSafetyMInterface()
...
try :
	...
	groundVehicleInterface.load_groundVehicle(DIR_share + '/tg/trx/TRX_DEMO_11GroundVehicles.trx')
	...
	assert flightWaypointNameArray == None
